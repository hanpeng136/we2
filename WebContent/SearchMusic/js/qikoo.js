...
qikoo.dialog = function() {
    ...
    var r = qikoo.dialog.show({
        html: ['<form action="SongSingleServlet.do" method="post" id="form5">','<div class="dialog-content">', '<div class="content-title">','标题：<input type="text" name="musicListName" id="musicListName" style="height:28px;width:200px;">','</from>','</div>','</div>',
...
qikoo.dialog3 = function() {
    var e, t, n = {}, r = function() {
            var n = ['<div class="mod-dialog3-bg"></div>', '<div class="mod-dialog3">', '<div class="dialog3-nav">', '<span class="dialog3-title"></span>', "</div>", '<div class="dialog3-main"></div>', "</div>"].join(""),
                r = $(n).hide().appendTo("body");
