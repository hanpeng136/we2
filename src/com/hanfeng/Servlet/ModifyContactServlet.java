...
public class ModifyContactServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int contact_id2 = Integer.parseInt(contact_id);
		int contact_age2 = Integer.parseInt(contact_age);
		double contact_weight2 = Double.parseDouble(contact_weight);
		Contact myContact = new Contact(contact_id2,contact_name,contact_class,contact_stuID,contact_age2,contact_birthday,
				contact_weight2,contact_phone,contact_remarks);		
		myContactService.updateContact(myContact);
